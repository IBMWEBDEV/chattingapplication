...
const Sidebar = ({ active }) => {
  ...
  className={`flex justify-center mt-[38px] ${
    active == "home" ? "after:bg-white" : "bg-red-500"
  }  py-[22px] w-[162px] h-[90px] ml-6 rounded-tl-[20px] 
     rounded-bl-[20px] relative after:content-[""] after:absolute 
     after:w-[8px] after:h-[90px] 
     after:rounded-tl-[25px] after:rounded-bl-[25px] after:top-0 after:right-0
